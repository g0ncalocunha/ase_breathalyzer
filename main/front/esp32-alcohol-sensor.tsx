...
const AlcoholSensorApp = () => {
  ...
  // Simulate button press and sensor reading
  const simulateButtonPress = () => {
    ...
    setTimeout(() => {
      ...
      setIsReading(false);
    }, 2000); // 2 second delay to simulate sensor reading
  };
  ...
  const handleRegisterScore = () => {
    if (currentReading !== null && isTopScore(currentReading)) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 mb-8 border border-white/20">
          <div className="text-center">
            ...
            {currentReading === null && !isReading && (
              <div className="py-8">
                <div className="text-3xl font-bold text-white/60 mb-4">
                  Press the button on the board to get started
                </div>
                <div className="text-6xl mb-4">🎯</div>
                <button
                  onClick={simulateButtonPress}
                  className="px-6 py-3 bg-blue-500 text-white rounded-lg font-semibold hover:bg-blue-600 transition-colors shadow-lg border border-blue-400"
                >
        ...
        <div className="text-center mt-8 text-white/60">
          <p>ESP32-C3 Alcohol Sensor Monitor | Press the physical button to take a reading</p>
        </div>
      </div>
    </div>
  );
